...
Point3f PNPSolver::get_distance(RotatedRect r, int armor_size)//vector <Point2f> points   RotatedRect r
{
	...
	points.push_back(Point2f(pt[3]));   //1 左上  20+    右下  150+
	points.push_back(Point2f(pt[0]));  //2 右上
	points.push_back(Point2f(pt[1]));  //3 右下
	points.push_back(Point2f(pt[2]));  //0 左下
	//points.push_back(Point2f(r.center));  //0 左下

	//points.push_back(Point2f(r.center.y - r.size.height / 2, r.center.x - r.size.width / 2));   //1 左上  20+    右下  150+
	//points.push_back(Point2f(r.center.y + r.size.height / 2, r.center.x - r.size.width / 2));  //2 右上
	//points.push_back(Point2f(r.center.y + r.size.height / 2, r.center.x + r.size.width / 2));  //3 右下
	//points.push_back(Point2f(r.center.y - r.size.height / 2, r.center.x + r.size.width / 2));  //0 左下
